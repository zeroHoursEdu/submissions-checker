# feedback-request Specification

## Purpose
Lets a subject owner request end-of-semester course feedback once per semester; each enrolled student gets a single-use tokenized link by email.
## Requirements
