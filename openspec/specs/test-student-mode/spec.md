# test-student-mode Specification

## Purpose
A teacher-provisioned TEST student per subject, excluded from grading stats, that the owner can enter as to pilot the student journey.
## Requirements
