...
Defines the teacher-facing "test student" QA feature: creating a disposable STUDENT account
enrolled in a subject so the owning teacher can dry-run assignment and grading setup before real
students enroll, including variant assignment for assignments that require one.
