...
Notify responsible teachers (or admins, as a fallback) when student submissions enter teacher review, coalescing multiple pending items into a single digest email per teacher to avoid notification spam.
